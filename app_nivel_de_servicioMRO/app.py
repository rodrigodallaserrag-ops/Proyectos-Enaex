...
def determinar_tipo_ariba(row):
    ...
    """
    # 1. Respetar clasificación previa explícita si ya viene en el DataFrame
...
if st.session_state.get("_clave_pipeline") != clave_actual:
    ...
    # 🔹 Clasificación inmediata de Tipo/Origen Ariba y SAP al cargar
...
# ---- Filtros: Centro, Aplica? y Tipo / Origen ----
...
checkpoints.append(("2b. Tras filtro Tipo / Origen", len(df_f)))

_snapshot("2. Tras Centro + Aplica + Tipo/Origen", df_f)
